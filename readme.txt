...
= 0.2.12 =
* Fix: Blacklist only blocks frontend checkout; never affects admin users

= 0.2.13 =
* Fix: Show CD Keys submenu regardless of Primary/Secondary mode

= 0.2.14 =
* Fix: Gate CD Keys submenu to Primary sites only

= 0.2.15 =
* Fix: Isolate Blacklist settings save to avoid resetting other options
...
= 0.2.18 =
* Change: Remove built-in Blacklist UI and enforcement (use external plugin)
...
= 0.2.21 =
* Maintenance: Version bump for release
